"""Cel Session Memory — CorvinOS-loadable provider (cel_session_memory).
...
class CelSessionMemoryPlugin:
    """Provider for cel_session_memory (orchestratable by ACP Skills)."""

    plugin_id = "cel_session_memory"
    plugin_type = "recall_backend"
    version = "0.1.0"
    display_name = "Cel Session Memory"
