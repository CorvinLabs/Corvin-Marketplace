"""Brain Learning Tracker — CorvinOS-loadable provider (brain_learning_tracker).
...
class BrainLearningTrackerPlugin:
    """Provider for brain_learning_tracker (orchestratable by ACP Skills)."""

    plugin_id = "brain_learning_tracker"
    plugin_type = "recall_backend"
    version = "0.1.0"
    display_name = "Brain Learning Tracker"
...
Plugin = BrainLearningTrackerPlugin
