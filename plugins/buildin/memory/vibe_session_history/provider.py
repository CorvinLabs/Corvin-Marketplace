"""Vibe Session History — CorvinOS-loadable provider (vibe_session_history).
...
class VibeSessionHistoryPlugin:
    """Provider for vibe_session_history (orchestratable by ACP Skills)."""

    plugin_id = "vibe_session_history"
    plugin_type = "recall_backend"
    version = "0.1.0"
    display_name = "Vibe Session History"
...
Plugin = VibeSessionHistoryPlugin
