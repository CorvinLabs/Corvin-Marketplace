"""User Model Learner — CorvinOS-loadable provider (user_model_learner).
...
class UserModelLearnerPlugin:
    """Provider for user_model_learner (orchestratable by ACP Skills)."""

    plugin_id = "user_model_learner"
    plugin_type = "recall_backend"
    version = "0.1.0"
    display_name = "User Model Learner"
