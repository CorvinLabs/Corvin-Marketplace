"""Data Classification — CorvinOS-loadable provider (data_classification).
...
class DataClassificationPlugin:
    """Provider for data_classification (orchestratable by ACP Skills)."""

    plugin_id = "data_classification"
