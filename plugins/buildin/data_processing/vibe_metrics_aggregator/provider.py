"""Vibe Metrics Aggregator — CorvinOS-loadable provider (vibe_metrics_aggregator).
...
class VibeMetricsAggregatorPlugin:
    """Provider for vibe_metrics_aggregator (orchestratable by ACP Skills)."""

    plugin_id = "vibe_metrics_aggregator"
    plugin_type = "data_connector"
    version = "0.1.0"
    display_name = "Vibe Metrics Aggregator"
...
Plugin = VibeMetricsAggregatorPlugin
