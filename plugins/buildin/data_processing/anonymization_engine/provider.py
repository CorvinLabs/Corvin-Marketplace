"""Anonymization Engine — CorvinOS-loadable provider (anonymization_engine).
...
class AnonymizationEnginePlugin:
    """Provider for anonymization_engine (orchestratable by ACP Skills)."""

    plugin_id = "anonymization_engine"
    plugin_type = "data_connector"
    version = "0.1.0"
    display_name = "Anonymization Engine"
...
Plugin = AnonymizationEnginePlugin
