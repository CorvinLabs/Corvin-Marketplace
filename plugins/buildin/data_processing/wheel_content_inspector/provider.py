"""Wheel Content Inspector — CorvinOS-loadable provider (wheel_content_inspector).
...
class WheelContentInspectorPlugin:
    """Provider for wheel_content_inspector (orchestratable by ACP Skills)."""

    plugin_id = "wheel_content_inspector"
    plugin_type = "data_connector"
    version = "0.1.0"
    display_name = "Wheel Content Inspector"
...
Plugin = WheelContentInspectorPlugin
