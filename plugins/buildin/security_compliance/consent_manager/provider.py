"""Consent Manager — CorvinOS-loadable provider (consent_manager).
...
(L18-21 UserBackend: per-user consent state); it is a TAXONOMY label here — ``on_load`` deliberately takes NO
