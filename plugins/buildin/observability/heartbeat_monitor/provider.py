"""Heartbeat Monitor — CorvinOS-loadable provider (heartbeat_monitor).
...
class HeartbeatMonitorPlugin:
    """Provider for heartbeat_monitor (orchestratable by ACP Skills)."""

    plugin_id = "heartbeat_monitor"
