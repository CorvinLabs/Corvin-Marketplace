"""Error Healing — CorvinOS-loadable provider (error_healing).
...
class ErrorHealingPlugin:
    """Provider for error_healing (orchestratable by ACP Skills)."""

    plugin_id = "error_healing"
    plugin_type = "audit_backend"
    version = "0.1.0"
    display_name = "Error Healing"
