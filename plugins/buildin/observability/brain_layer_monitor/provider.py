"""Brain Layer Monitor — CorvinOS-loadable provider (brain_layer_monitor).
...
class BrainLayerMonitorPlugin:
    """Infrastructure plugin — always active, not orchestrated by Skills."""

    plugin_id = "brain_layer_monitor"
    plugin_type = "audit_backend"
    version = "0.1.0"
    display_name = "Brain Layer Monitor"
...
Plugin = BrainLayerMonitorPlugin
