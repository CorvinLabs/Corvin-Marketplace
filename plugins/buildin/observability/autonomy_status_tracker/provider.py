"""Autonomy Status Tracker — CorvinOS-loadable provider (autonomy_status_tracker).
...
class AutonomyStatusTrackerPlugin:
    """Provider for autonomy_status_tracker (orchestratable by ACP Skills)."""

    plugin_id = "autonomy_status_tracker"
    plugin_type = "audit_backend"
    version = "0.1.0"
    display_name = "Autonomy Status Tracker"
...
Plugin = AutonomyStatusTrackerPlugin
