"""Bridge Adapter — CorvinOS-loadable provider (bridge_adapter).
...
(Bridge: a channel/hub integration); it is a TAXONOMY label here — ``on_load`` deliberately takes NO
